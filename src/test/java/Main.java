...
public class Main {
	...
	public static void main(String[] args) {
		 ...
		 * B aa = new A(); aa = new A();
		 * 
		 * int intArray[]; intArray = new int[3]; intArray[1] = 1; intArray[2] =
		 * 2; intArray[3] = 3; int g[] = {1,2,3,1,2}; int asd[][] = new
		 * int[2][]; asd[0] = new int[3]; asd[1] = new int[3];
		 */

		/*
		 * void waitForSignal(){ Object obj = new Object(); synchronized
		 * (Thread.currentThread()){ obj.wait(); obj.notify(); } }
		 */
		Main main = new Main();
