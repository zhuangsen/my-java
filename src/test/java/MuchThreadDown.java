...
public class MuchThreadDown {
	...
	private static String path = "https://nodejs.org/dist/v6.10.3/node-v6.10.3.pkg";
		...
		public void run() {
			...
			try {
				...
				if (file2.exists()) {
					...
					openConnection.setRequestProperty("Range", "bytes:" + lastPostion + "-" + endIndex);// bytes:0-500:请求服务器资源中0-500之间的字节信息
																										// 501-1000:
	...
	public static String getFileName(String url) {
		return "/Users/madison/Documents"+url.substring(url.lastIndexOf("/"));
	}
}